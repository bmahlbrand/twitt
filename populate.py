...
# Add one user
user=('dave@gmail.com', 'dave123', 'george martin', '123 main st', 'nonsense')
c.execute('INSERT INTO users VALUES (?,?,?,?,?,1)', user)

# Larger example that inserts many records at a time
users = [('george@gmail.com', 'abc123', 'george martin', '123 main st', 'nonsense',1),
             ('mary@gmail.com', 'mary123', 'george martin', '123 main st', 'nonsense',1),
             ('peter@gmail.com', 'peter123', 'george martin', '123 main st', 'nonsense',1),
            ]
